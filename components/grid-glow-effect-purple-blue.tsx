...
interface GlowingEffectProps {
  ...
  proximity?: number;
  spread?: number;
  variant?: "default" | "white" | "blue-purple" | "blue-purple-dark";
  glow?: boolean;
  className?: string;
  disabled?: boolean;
...
const gradients = {
  ...
  "blue-purple-dark": `radial-gradient(circle at 25% 25%, rgba(59, 130, 246, 0.2) 0%, transparent 30%),
                  radial-gradient(circle at 75% 25%, rgba(147, 51, 234, 0.2) 0%, transparent 30%),
                  radial-gradient(circle at 25% 75%, rgba(168, 85, 247, 0.2) 0%, transparent 30%),
                  radial-gradient(circle at 75% 75%, rgba(99, 102, 241, 0.2) 0%, transparent 30%),
                  repeating-conic-gradient(
                    from calc(var(--start) * 1deg) at 50% 50%,
                    rgba(59, 130, 246, 0.7) 0%,
                    rgba(147, 51, 234, 0.8) calc(25% / var(--repeating-conic-gradient-times)),
                    rgba(168, 85, 247, 0.75) calc(50% / var(--repeating-conic-gradient-times)),
                    rgba(99, 102, 241, 0.7) calc(75% / var(--repeating-conic-gradient-times)),
                    rgba(59, 130, 246, 0.7) calc(100% / var(--repeating-conic-gradient-times))
                  )`,
};
